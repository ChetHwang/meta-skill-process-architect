...
```bash
process-architect scan --source confluence://wiki.example.com/refund-process --output draft/
...
## Sources Scanned
- [Confluence: Customer Refund SOP](https://wiki.example.com/...) — 45 fields extracted
- [Jira: REF project](https://jira.internal.com/...) — 12 transitions extracted
